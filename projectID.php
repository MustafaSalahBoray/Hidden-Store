          ...
          <?php 
                 ...
                 if (isset($_GET['productID'])) {
                  ...
                  if (!isset($_GET['Brands'])) {
                                  $showid=$db->prepare("SELECT * FROM products WHERE productID=:id ");
                                  $showid->bindparam("id",$_GET['productID']);
                                     $showid->execute();
                      foreach ($showid as $key) { 
                    ...
                    <div class="col-md-4 mb-2">
                             <div class="card">
                              ...
                              <div class="card-body">
                               ...
                               <a href="http://localhost/Hidden%20Store/" class="btn btn-secondary">Go Home </a>
                </div> 
                    </div> 
                          ...
                          <div class="col-md-8">
                             <div class="row"> 
                                  ...
                                  <div class="col-md-6">
                                  <img src="ProductImg/'.$key['image2'].'" className="card-img-top" alt="mm"   />
                                  </div>
                                  <div class="col-md-6">
                                  <img src="ProductImg/'.$key['image3'].'" className="card-img-top" alt="mm"   />
                                  </div>
                             </div>
                          </div>
